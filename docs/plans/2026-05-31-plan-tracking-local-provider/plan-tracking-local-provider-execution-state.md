...
| 4.1 | done | Service feasibility eval | sympoies/nils-cli#711 (merge bcc1e94) | Conditional GO for a Half A issue/plan-tracking service; eval only, no build. Dep 3.1. |
