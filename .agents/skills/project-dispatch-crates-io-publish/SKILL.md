...
- `<PROJECT_ROOT>/.agents/skills/project-dispatch-crates-io-publish/scripts/publish-crates-io.sh`
...
5. Write a structured report from template:
   - `.agents/skills/project-dispatch-crates-io-publish/references/PUBLISH_REPORT_TEMPLATE.md`
