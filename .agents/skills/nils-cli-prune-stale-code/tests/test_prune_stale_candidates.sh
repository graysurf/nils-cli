...
script="${skill_dir}/scripts/nils-cli-prune-stale-code.sh"
...
artifact_root="${CLAUDE_KIT_STATE_HOME:-${XDG_STATE_HOME:-$HOME/.local/state}/agent-runtime-kit}/out/nils-cli-prune-stale-code-tests"
