...
The MVP allowlist covers the canonical `projects/` root, current home-scope policy roots, and explicit tool/workflow roots already documented in nils-cli or agent-kit:
