...
- **Validation**:
  - cargo test -p nils-plan-issue start_sprint_grouping_default_inferred_when_plan_only -- --exact
"#,
    )
...
- **Acceptance criteria**:
  - Setup completes.
- **Validation**:
  - cargo test -p nils-plan-issue start_sprint_grouping_default_inferred_for_group_intent -- --exact
...
- **Acceptance criteria**:
  - CLI wins.
- **Validation**:
  - cargo test -p nils-plan-issue start_sprint_grouping_cli_overrides_plan_metadata -- --exact
"#,
    )
    .expect("write plan fixture");
...
- **Validation**:
  - cargo test -p nils-plan-issue start_sprint_grouping_silent_plan_still_requires_explicit_flags -- --exact
"#,
    )
    .expect("write plan fixture");
