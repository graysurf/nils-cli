...
fn render_markdown(manifest: &SurfacesManifest) -> String {
    let mut lines = vec![
        ...
        String::new(),
        "Unified human-readable view of which Codex, Claude, and Hermes harness primitives `agent-runtime-kit` ships into today, by what mechanism, and at what version floor.".to_string(),
        String::new(),
        "## Matrix".to_string(),
        String::new(),
