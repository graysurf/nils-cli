...
| `lipo`, `codesign`, `spctl` | Architecture, exact signing-identity, CLI notarization, and app Gatekeeper/notary verification for the locked Peekaboo backend | Required on macOS for strict install/verify/doctor | Preinstalled with macOS/Xcode command-line tools |
